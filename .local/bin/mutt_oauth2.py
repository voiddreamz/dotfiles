...
registrations = {
    ...
    'yandex': {
        ...
        'imap_endpoint': 'imap.yandex.com',
        'smtp_endpoint': 'smtp.yandex.com',
        'sasl_method': 'XOAUTH2',
        # 注意:pop_endpoint 有意不提供 —— Yandex 的 POP3 不支持 OAuth。
        # 用 --test 时 POP 段会报错(KeyError),属预期,只看 IMAP/SMTP 段即可。
